...
class PaginatedAPIMixin(object):
    ...
    def to_collection_dict(requete, page, per_page, endpoint, **kwargs):
        ressources = requete.paginate(page=page, per_page=per_page, error_out = False)
        data = {
            ...
            '_links':{
                ...
                'suivant':url_for(endpoint, page=page - 1, per_page=per_page, **kwargs) if ressources.has_prev else None
            }            
        }
        return data
